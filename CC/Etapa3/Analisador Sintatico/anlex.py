...
#################### Estado 0 ####################
        if estado == 0:
            if carac == ':':
                ...
                if not carac:   # eof ''
                    break
                return ('ERRO', carac, (nlinha, ncoluna))
...
#################### Estado 68 ####################
            ...
            if carac in IDS:    # IDS
                ...
                if ntk == tk:
                    return ('tipo', 'FLOAT',  (nlinha, ncoluna))
                else:
                    ntk += 1
                    strSimb = ''
                    estado = 0
...
#################### Estado 81 ####################
            ...
            if carac in IDS:    # IDS
                ...
                if ntk == tk:
                    return ('tipo', 'CHAR',  (nlinha, ncoluna))
                else:
                    ntk += 1
                    strSimb = ''
                    estado = 0
...
#################### Estado 95 ####################
            ...
            if carac in IDS:    # IDS
                ...
                if ntk == tk:
                    return ('tipo', 'INT',  (nlinha, ncoluna))
                else:
                    ntk += 1
                    strSimb = ''
                    estado = 0
