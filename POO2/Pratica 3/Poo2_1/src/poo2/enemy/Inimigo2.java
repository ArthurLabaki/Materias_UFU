...
public class Inimigo2 extends Inimigo{
    ...
    public void update(Observable subject, Object arg) {
        ...
        if(( Math.abs(this.getX() - pers.getX()) < 5) && (Math.abs(this.getY() - pers.getY()) < 5)){
           ...
           if (pers.getX() > this.getX()) this.setX(this.getX()+(int)(15*Math.random()));
           else this.setX(this.getX()-(int)(15*Math.random()));
           //se precisa andar para tras
           if (pers.getY() > this.getY()) this.setY(this.getY()+(int)(15*Math.random()));
           else this.setY(this.getY()-(int)(15*Math.random()));
