...
public abstract class Personagem extends Observable implements KeyListener {
    ...
    public void status(){
        ...
        System.out.println(this.a.getDano());
        System.out.println("\n");
    }
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_SPACE){
            a.atacar();
            // Atualizar ataque caso personagem mude de estado ou pegue poderes
            for(int i = 0; i < 10; i++){
                if(((this.getX() - inimigos[i].getX()) == 0) && ((this.getY() - inimigos[i].getY()) == 0) && inimigos[i].getVida() > 0){
                    inimigos[i].causarDano(a.getDano());
                }
            }
        ...
        if (e.getKeyCode() == KeyEvent.VK_E){
            ...
            if((Math.abs(this.getX() - e1.getX()) <= 10) && (Math.abs(this.getY() - e1.getY()) <= 10) && (e1.existe == true)){
                ...
                System.out.println(e1.tipo+" adquirido!");
            ...
            if((Math.abs(this.getX() - e2.getX()) <= 10) && (Math.abs(this.getY() - e2.getY()) <= 10)&& (e2.existe == true)){
                ...
                System.out.println(e2.tipo+" adquirido!");
            ...
            if((Math.abs(this.getX() - e3.getX()) <= 10) && (Math.abs(this.getY() - e3.getY()) <= 10) && (e3.existe == true)){
                ...
                System.out.println(e3.tipo+" adquirido!");
