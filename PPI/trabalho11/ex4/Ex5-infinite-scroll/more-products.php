...
class Product // produtos (objeto)
{
  ...
  function __construct($id, $name, $price, $imagePath) //construtor
  {
    $this->id = $id;
    $this->name = $name;
    $this->price = $price;
...
$randProds = [
  // array aleatorio que seleciona 5 produtos aleatorios
  $products[rand(0, 6)],
  $products[rand(0, 6)],
  $products[rand(0, 6)],
  $products[rand(0, 6)],
