...
<head>
    ...
    <style>
        ...
        main .home-box .anuncios {
            display: flex;
            justify-content: space-around;
        }

        main .home-box .anuncios a {
            border-radius: 25px;
        ...
        main .home-box .anuncios a:hover {
...
<body>
    ...
    <main>
        <div class="home-box">
            <h1 id="teste">Bem Vindo o CrowSpot <u>
            ...
            <br>
            <div class="anuncios">
                <a href="cAnuncio.php" id="cA">Criar um novo anúncio</a>
                <a href="lAnuncio.php" id="vA">Ver anúncios</a>
                <a href="eAnuncio.php" id="vA">Excluir anúncios</a>
                <a href="alterar.php" id="vA">Alterar cadastro</a>
            </div>
