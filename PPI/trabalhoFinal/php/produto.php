...
<body>
    ...
    <main id="mainContent">
        <div class="fullCard">
            <div class="dir">
                ...
                <input type="text" id="mensagemInput" placeholder="Digite sua mensagem" required>
                <input type="text" id="contatoInput" placeholder="Digite seu contato" required>
                <button type="button" id="btnCont">Contatar Anunciante!</button>

                <div id="errorDiv" style="display: none; color: red;">
                    <p id="loginFailMsg">Ocorreu um erro ao enviar a mensagem.</p>
                </div>
    ...
    <script>
        ...
        document.getElementById("btnCont").addEventListener("click", function () {
            ...
            var contato = document.getElementById("contatoInput").value;
            var codAnuncio = <?php echo $codigoAnuncio; ?>;
            if (mensagem.length > 0 && contato.length > 0) {
                var data = {
                    mensagem: mensagem,
                    contato: contato,
                ...
                fetch("interesse.php", {
                    ...
                    .then(function (response) {
                        if (response.ok) {
                            window.location.href = "home.php"; // Redireciona para a página home.php
                        } else {
                    ...
                    .catch(function (error) {
                        ...
                        document.getElementById("errorDiv").style.display = "block"; // Mostra a mensagem de erro
                    });
            } else {
