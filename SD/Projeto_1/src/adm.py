...
if __name__ == '__main__':
    port = int(input("Porta (default 12345): "))
    while 1:
        ...
        if comando == 'cliente' or comando == '1':
            ...
            if comando == "inserir" or comando == '1':
                ...
                print(
                    "Impossivel de mudar o cpf, favor exluir e recriar cliente caso necessário!")
                cpf = CID
            ...
            if comando == 'inserir' or comando == '1':
                ...
                print(
                    "Impossivel de mudar o nome, favor exluir e recriar produto caso necessário!")
